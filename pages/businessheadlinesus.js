  ...
  return (
    <Carousel showThumbs={false} className={styles.carouselcontainer}>
      {newsData.articles.map((article,index) => {
        ...
        return (
          <div >
          <h1 className={styles.header}>Top Business Headlines In The US</h1>
...
export const getStaticProps = async () => {
  ...
  const apiUrl = "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=39bdf0ae44e74999b540cbd7499068f0";
